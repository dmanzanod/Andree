...
$sql="SELECT fono_saldo from frm_historic where nro_folio = '".$_GET['folio']."';";
...
if ($row != 0)
{
    ...
    $sql1="SELECT mnt_UF_fono FROM tbl_asegurado WHERE rut_asegurado = '".$_GET['rut']."' Limit 1;";
    $result1 = mysqli_query($con,$sql1);


    while($row1 = mysqli_fetch_array($result1)) {
        echo $row1['mnt_UF_fono'];
    }
