...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
	...
	<title>APP BIENESTAR ANDREE SCHOOL</title>
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50"  align="center">
				<form id="frmLogin" class="login100-form validate-form" action="index2.php" method="post">
					<span class="login100-form-title p-b-33"  align="center">
						<img src="./LOGOTIPO_COLOR1.jpg" alt="" style="width:150px;height:150px;">
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Se requiere un formato de correo: ejemplo@andreebienestar.cl"  align="center">
						<input class="input100" type="text" name="email" placeholder="Usuario" value = "<?php echo $_SESSION['login_user']; ?>" readonly>
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>

					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required"  align="center">
					...
					<div class="container-login100-form-btn m-t-20" align="center">
						<input class="fadeIn fourth" type="submit" value="CAMBIAR CLAVE">
					</div>
